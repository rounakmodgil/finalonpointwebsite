...
import "./Home3.css";
import pizza from "./images/illustration2.png";
      ...
      <div className="home3-section">
        ...
        >
          ...
          <p className="home3-content-text">
            ...
            way to use "word of mouth" advertising. Reviews have the ability to
            enhance merchant credibility, improve comparison shopping rankings,
