...
import "./Home.css";
import mainlogo from "./images/whiteonpointlogo.png";
import ramen from "./images/illustration.png";
import {
  FaUtensils,
  FaCertificate,
  FaMoneyBill,
          ...
          >
            <div>
              ...
              <p className="home-content-text">
                ...
                about how it will be? Check what people think about it before
                you experience it. Check On Point!{" "}
              </p>
              <div className="home-list-content">
                ...
                <div>
                  <div className="home-list-item">
                    ...
                    <p style={{ marginLeft: "10px" }}>
                      Check tv shows and movie reviews
                    </p>
                  </div>
                  <div className="home-list-item">
                    <FaUntappd color={"#552e30"} size={20} />
                    <p style={{ marginLeft: "10px" }}>
                      Basically, we review everything!
                    </p>
                  </div>
                </div>
              </div>
